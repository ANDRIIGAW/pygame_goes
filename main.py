...
def create_enemy():
    ...
    enemy_sreed = random.randint(4, 6)
    return [enemy, enemy_rect, enemy_sreed]
...
CHENGE_IMG = pygame.USEREVENT + 3
pygame.time.set_timer(CHENGE_IMG, 125)
